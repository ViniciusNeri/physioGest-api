...
export interface IAgendaService {
   ...
   * @param categoryId - (Opcional) ID da categoria para considerar sua duração específica
   */
  getAvailableSlots(userId: string, date: string, categoryId?: string): Promise<string[]>;
}