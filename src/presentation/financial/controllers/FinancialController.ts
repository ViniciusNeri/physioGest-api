...
export class FinancialController {
   ...
   */
  getConsolidated = async (req: Request, res: Response) => {
    try {
      ...
      const consolidated = await this.service.getMonthlyConsolidated(
        userId as string, 
        Number(month), 
        Number(year)
      );
  ...
  delete = async (req: Request, res: Response) => {
    try {
      ...
      const deleted = await this.service.deleteFinancial(
        id as string, 
