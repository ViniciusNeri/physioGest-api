...
export const createRequestLogger = (options = {}) => {
    const { logRequestBody = false, logResponseBody = false, logHeaders = false, excludePaths = ['/health', '/favicon.ico'], maskFields = ['password', 'token', 'authorization', 'api-key'] } = options;
    return (req, res, next) => {
...
function maskSensitiveData(data, maskFields) {
